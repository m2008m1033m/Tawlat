...
public class RecommendedVenuesAdapter extends RefreshAdapter {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            mButton.setText(R.string.menu);

        }
    }

    private ArrayList<RecommendedVenue> mItems = new ArrayList<>();

    private OnActionListener mOnActionListener;

    public RecommendedVenuesAdapter(OnActionListener listener) {
        mOnActionListener = listener;
    }

    @Override
    public ArrayList<RecommendedVenue> getItems() {
        return mItems;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder vh, int position) {
        final RecommendedVenue item = this.mItems.get(position);
